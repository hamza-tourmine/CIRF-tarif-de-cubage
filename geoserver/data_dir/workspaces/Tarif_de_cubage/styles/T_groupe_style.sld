      ...
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:PolygonSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#f90e16</se:SvgParameter>
        ...
        <se:Rule>
          <se:TextSymbolizer>
            <se:Label>
              <ogc:PropertyName>nom_groupe</ogc:PropertyName>
            </se:Label>
            <se:Font>
            ...
            <se:Fill>
              <se:SvgParameter name="fill">#f90e16</se:SvgParameter>
            </se:Fill>
